...
async def registerx(event):
    ...
    if results :
        ...
        post_dict1 = {"_id": sender.id, "Name": name, "Level": 1, "Rank": "D-Class", "EXP": 10, "Points": 100, "Gender": "No", "Partner": "No", "Friend": "No", "Father": "No", "Mother": "No", "Children": "No", "Status": "No", "Bounty": 0, "Deposit": 0}
