...
GET_HANDLER = CommandHandler("kget", cmd_get, run_async=True)
...
SAVE_HANDLER = CommandHandler("ksave", save, run_async=True)
DELETE_HANDLER = CommandHandler("kclear", clear, run_async=True)

LIST_HANDLER = DisableAbleCommandHandler(["knotes", "ksaved"], list_notes, admin_ok=True, run_async=True)

CLEARALL = DisableAbleCommandHandler("kremoveallnotes", clearall, run_async=True)
