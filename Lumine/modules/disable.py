...
if is_module_loaded(FILENAME):
    ...
    DISABLE_HANDLER = CommandHandler("kdisable", disable, run_async=True)
    DISABLE_MODULE_HANDLER = CommandHandler("kdisablemodule", disable_module, run_async=True)
    ENABLE_HANDLER = CommandHandler("kenable", enable, run_async=True)
    ENABLE_MODULE_HANDLER = CommandHandler("kenablemodule", enable_module, run_async=True)
    COMMANDS_HANDLER = CommandHandler(["kcmds", "kdisabled"], commands, run_async=True)
    TOGGLE_HANDLER = CommandHandler("klistcmds", list_cmds, run_async=True)
