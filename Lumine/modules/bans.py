...
BAN_HANDLER = DisableAbleCommandHandler(["kban", "ksban"], ban, run_async=True)
TEMPBAN_HANDLER = DisableAbleCommandHandler("ktban", temp_ban, run_async=True)
PUNCH_HANDLER = DisableAbleCommandHandler(["kpunch", "kkick"], punch, run_async=True)
UNBAN_HANDLER = DisableAbleCommandHandler("kunban", unban, run_async=True)
ROAR_HANDLER = DisableAbleCommandHandler(["roar", "runban"], selfunban, run_async=True)
