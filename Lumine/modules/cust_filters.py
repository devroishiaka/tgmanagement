...
FILTER_HANDLER = CommandHandler("ksetfilter", filters)
STOP_HANDLER = CommandHandler("kstop", stop_filter)
RMALLFILTER_HANDLER = CommandHandler(
    "kremoveallfilters", rmall_filters, filters=Filters.chat_type.groups, run_async=True
)
RMALLFILTER_CALLBACK = CallbackQueryHandler(rmall_callback, pattern=r"filters_.*", run_async=True)
LIST_HANDLER = DisableAbleCommandHandler("kfilters", list_handlers, admin_ok=True, run_async=True)
