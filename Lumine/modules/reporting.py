...
SETTING_HANDLER = CommandHandler("kreports", report_setting, run_async=True)
REPORT_HANDLER = CommandHandler("kreport", report, filters=Filters.chat_type.groups, run_async=True)
