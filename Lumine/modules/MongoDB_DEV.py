...
def devregister(update: Update, context: CallbackContext):
    ...
    post_dict1 = {"_id": user_id, "Name": name, "EXP": 10, "Level": 1, "Rank": "D-Class", "Points": 100, "Gender": "No", "Partner": "No", "Friend": "No", "Parents": "No", "Parents": "No", "Children": "No", "Status": "No", "Bounty": 0, "Deposit": 0, "TDeposit": 0, "Weapons": ["Knife"], "WeaSet": [1, 2, 3, 4], "Skills": ["No"], "Health": 100, "DWins": 0, "DTotal": 0, "Invantory": ["No"], "Achievment": ["No"]}
